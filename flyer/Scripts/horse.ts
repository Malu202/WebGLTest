...
var runHorse = function () {
    ...
    var ani: BABYLON.Animatable;
    SceneLoader.ImportMesh("Sphere", "Assets/", "Horse_turned.babylon", scene, (meshes, p, s) => {
        character = meshes[0];
    ...
    var tree: BABYLON.AbstractMesh;
    SceneLoader.ImportMesh("Plane.041", "Assets/", "testbaum.babylon", scene, (meshes, p, s) => {
        tree = meshes[0];
    ...
    function heightMapCollision(mesh: BABYLON.AbstractMesh) {
        if (!mesh)
            return;
